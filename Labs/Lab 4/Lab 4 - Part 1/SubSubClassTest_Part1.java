 ...
 * @author schr
 */
public class SubSubClassTest_Part1 {
    
    public SubSubClassTest_Part1() {
    }
    ...
    public void testConstructorChains()  {
        ...
        // Assert.assertEquals(7, object.getB());  		//The parent can't access its child's instance variables
